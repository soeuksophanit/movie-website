      ...
      <nav class="bg-[#111319] border-gray-200 dark:bg-gray-900 text-white">
        ...
        >
          ...
          >
            ...
            >
             <li class="link-item">
                <a class="active max-[766px]:inline-block" href="#">Home</a>
             </li>
             <li class="link-item">
                <a class=" max-[766px]:inline-block" href="#pop">Popular</a>
             </li>
             <li class="link-item">
                <a class=" max-[766px]:inline-block" href="#entertainment">Top Pick</a>
             </li>
             <li class="link-item">
                <a class=" max-[766px]:inline-block" href="#c-drama">C-Drama</a>
             </li>
             <li class="link-item">
                <a class=" max-[766px]:inline-block" href="#k-drama">K-Drama</a>
             </li>
             <li class="link-item">
                <a class=" max-[766px]:inline-block" href="#animation">Animation</a>
             </li>
             <li class="link-item">
                <a class=" max-[766px]:inline-block" href="#var-show">Variety Show</a>
             </li>
            </ul>
          </div>
        </div>
